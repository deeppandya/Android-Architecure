package mainpackage.arch.model;
...
import mainpackage.arch.database.ListDataConverter;
...
public class MovieResultModel implements Parcelable {
    ...
    public MovieResultModel(@NonNull int page, int totalResults, List<MovieModel> results) {
        this.page = page;
